...
public class PasswordUtilisateur {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PasswordUtilisateur window = new PasswordUtilisateur();
	...
	private void initialize() {
		...
		Login.setBounds(100, 100, 321, 152);
	...
	private void login(ActionEvent e) {
		if(getTextField().isEmpty() && getPasswordField().isEmpty() ) {
			error2.setVisible(true);
			Error1.setVisible(true);	
		}else if (getPasswordField().isEmpty() && getTextField() != null ) {
			error2.setVisible(true);
			Error1.setVisible(false);
		} else if (getTextField().isEmpty() && getPasswordField() != null ) {
			error2.setVisible(false);
			Error1.setVisible(true);
			
		} else if (getTextField() != null && getPasswordField() != null){
			Error1.setVisible(false);
			error2.setVisible(false);
			JOptionPane.showMessageDialog(null,"Bienvenue " + getTextField() +  " à la bibliothèque virtuelle !", 
